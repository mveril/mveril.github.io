...
- Since October 2018 update it's also possible to launch the default distro from Windows explorer. For that press shift key and right click. Then click on `Open a Linux Shell here`![img](https://40jajy3iyl373v772m19fybm-wpengine.netdna-ssl.com/wp-content/uploads/sites/33/2019/02/Linux-Shell-600x507.png)](https://devblogs.microsoft.com/commandline/whats-new-for-wsl-in-the-windows-10-october-2018-update/) 
